    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(CreateWorkItemParamsSchema),
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(AbortWorkItemParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetWorkItemParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetWorkItemSchemaParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(UpdateWorkItemParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(UpdateWorkItemRoleOwnersParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetViewDetailParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetWorkItemWorkflowParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(ConfirmNodeParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(RollbackNodeParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(ChangeStateParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(CreateCommentParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetCommentsParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(UpdateCommentParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(DeleteCommentParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetScheduleParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetUserParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetUsersByIdsParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetTeamsParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
    ...
    api.registerTool(
      {
        ...
        parameters: z.toJSONSchema(GetBusinessesParamsSchema),
        execute: async (_id: string, params: unknown) => {
          try {
            return json(
